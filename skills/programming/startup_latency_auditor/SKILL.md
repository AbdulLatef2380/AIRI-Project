---
name: startup_latency_auditor
description: Reduce cold and warm startup work safely Use when the user requests startup latency auditor.
---

# Startup Latency Auditor

## Description

Reduce cold and warm startup work safely
...
Use this skill when the user's request matches `startup_latency_auditor` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to startup latency auditor using supplied evidence.
