...
description: Official AIRI skill for github guardian. Use when the user requests github guardian.
---
...
Official AIRI skill for github guardian.
...
Use this skill when the user's request matches `github_guardian` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to github guardian using supplied evidence.
