...
## Description
Plan bounded, authorized, non-destructive security tests.
...
## Inputs
scope, authorization, objectives, and risk constraints

## Outputs
test plan, safety gates, stop conditions, and remediation outputs
...
## Limitations
Use before approved testing; authorization must be verified outside the model.
