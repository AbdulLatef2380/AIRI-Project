...
description: Prepare interview questions and actionable feedback Use when the user requests interview coach.
---
...
Prepare interview questions and actionable feedback
...
Use this skill when the user's request matches `interview_coach` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to interview coach using supplied evidence.
