---
name: drive_search
description: Official AIRI skill for drive search. Use when the user requests google drive search.
---
...
Official AIRI skill for drive search.
...
Use this skill when the user's request matches `drive_search` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to google drive search using supplied evidence.
