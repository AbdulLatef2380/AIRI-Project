...
description: Official AIRI skill for telegram messenger. Use when the user requests telegram messenger.
---
...
Official AIRI skill for telegram messenger.
...
Use this skill when the user's request matches `telegram_messenger` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to telegram messenger using supplied evidence.
