---
name: memory_manager
description: Official AIRI skill for memory manager. Use when the user requests memory manager.
---
...
Official AIRI skill for memory manager.
...
Use this skill when the user's request matches `memory_manager` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to memory manager using supplied evidence.
