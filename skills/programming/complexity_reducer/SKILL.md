...
description: Reduce complexity while preserving behavior and testability Use when the user requests complexity reducer.
---
...
Reduce complexity while preserving behavior and testability
...
Use this skill when the user's request matches `complexity_reducer` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to complexity reducer using supplied evidence.
