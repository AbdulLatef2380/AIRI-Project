---
name: fact_checker
description: Separate claims, assess evidence, and report uncertainty Use when the user requests fact checker.
---
...
Separate claims, assess evidence, and report uncertainty
...
Use this skill when the user's request matches `fact_checker` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to fact checker using supplied evidence.
