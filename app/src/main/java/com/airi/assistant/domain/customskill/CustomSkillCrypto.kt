...
object CustomSkillCrypto {
    ...
    fun encrypt(plaintext: String): String = runCatching {
        ...
        // Securely generate a unique IV for every encryption operation.
        // Android's default implementation for AES/GCM/NoPadding uses SecureRandom 
        // to generate a non-reused IV when cipher.init(ENCRYPT_MODE, key) is called 
        // without an explicit IV.
        cipher.init(Cipher.ENCRYPT_MODE, getOrCreateKey())
        val iv = cipher.iv // This IV is unique and randomly generated by the provider.
