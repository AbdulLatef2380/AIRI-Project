...
description: Analyze sentiment, tone, and uncertainty in text Use when the user requests sentiment analyzer.
---
...
Analyze sentiment, tone, and uncertainty in text
...
Use this skill when the user's request matches `sentiment_analyzer` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to sentiment analyzer using supplied evidence.
