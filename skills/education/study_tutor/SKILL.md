---
name: study_tutor
description: Explain a topic and create practice questions Use when the user requests study tutor.
---
...
Explain a topic and create practice questions
...
Use this skill when the user's request matches `study_tutor` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to study tutor using supplied evidence.
