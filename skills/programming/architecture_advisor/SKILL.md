...
description: Compare architecture options against constraints and failure modes Use when the user requests architecture advisor.
---
...
Compare architecture options against constraints and failure modes
...
Use this skill when the user's request matches `architecture_advisor` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to architecture advisor using supplied evidence.
