...
description: Create an incremental quality-improvement plan from a codebase hotspot Use when the user requests refactoring planner.
---
...
Create an incremental quality-improvement plan from a codebase hotspot
...
Use this skill when the user's request matches `refactoring_planner` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to refactoring planner using supplied evidence.
