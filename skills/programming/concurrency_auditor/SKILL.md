...
description: Find blocking, cancellation, race, and dispatcher mistakes Use when the user requests concurrency auditor.
---
...
Find blocking, cancellation, race, and dispatcher mistakes
...
Use this skill when the user's request matches `concurrency_auditor` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to concurrency auditor using supplied evidence.
