...
description: Evaluate and improve prompts through critique and revision Use when the user requests prompt evaluator.
---
...
Evaluate and improve prompts through critique and revision
...
Use this skill when the user's request matches `prompt_evaluator` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to prompt evaluator using supplied evidence.
