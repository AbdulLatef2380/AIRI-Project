...
class DataDeletionCoordinator(
    ...
    suspend fun deleteAccount(): DeletionResult {
        ...
        Log.i(TAG, "AIRI_RUNTIME GDPR_DELETE_INITIATED")
        ...
        if (authError != null) {
            ...
            Log.w(TAG, "AIRI_RUNTIME GDPR_DELETE_FIREBASE_FAILED requiresReauth=$needsReauth reason=$authError")
        ...
        Log.i(TAG, "AIRI_RUNTIME GDPR_DELETE_FIREBASE_SUCCESS")
        ...
        return if (failures.isEmpty()) {
            Log.i(TAG, "AIRI_RUNTIME GDPR_DELETE_SUCCESS steps=${completed.size}")
            ...
            Log.w(TAG, "AIRI_RUNTIME GDPR_DELETE_PARTIAL succeeded=$successCount failed=${failures.size} steps=$failedNames")
