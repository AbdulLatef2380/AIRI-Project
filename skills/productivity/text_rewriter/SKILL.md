---
name: text_rewriter
description: Rewrite text for a requested tone, audience, or clarity level Use when the user requests text rewriter.
---
...
Rewrite text for a requested tone, audience, or clarity level
...
Use this skill when the user's request matches `text_rewriter` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to text rewriter using supplied evidence.
