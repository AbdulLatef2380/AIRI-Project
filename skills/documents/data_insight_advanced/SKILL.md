---
name: data_insight_advanced
description: Turn tabular or textual data into cautious insights Use when the user requests advanced data insights.
---
...
Turn tabular or textual data into cautious insights
...
Use this skill when the user's request matches `data_insight_advanced` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to advanced data insights using supplied evidence.
