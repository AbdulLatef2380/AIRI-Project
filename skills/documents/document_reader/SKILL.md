...
description: Official AIRI skill for document reader. Use when the user requests document reader.
---
...
Official AIRI skill for document reader.
...
Use this skill when the user's request matches `document_reader` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to document reader using supplied evidence.
