...
This document describes the AIRI connector catalog entry for **Linear**. The entry is an AIRI adapter definition, not a claim that AIRI is the provider or owner of the external service.
