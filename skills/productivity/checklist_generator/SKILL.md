...
description: Turn a goal or procedure into a verifiable checklist Use when the user requests checklist generator.
---
...
Turn a goal or procedure into a verifiable checklist
...
Use this skill when the user's request matches `checklist_generator` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to checklist generator using supplied evidence.
