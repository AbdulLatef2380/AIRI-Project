---
name: translator
description: Official AIRI skill for translator. Use when the user requests translator.
---
...
Official AIRI skill for translator.
...
Use this skill when the user's request matches `translator` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to translator using supplied evidence.
