...
description: Summarize a meeting transcript into decisions and action items Use when the user requests meeting summarizer.
---
...
Use this skill when the user's request matches `meeting_summarizer` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to meeting summarizer using supplied evidence.
