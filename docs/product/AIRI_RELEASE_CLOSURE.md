...
| Build/package | Debug, lint, R8 release packaging, signed APK/AAB, `apksigner`, API 29 instrumentation, and native verification succeed in CI. On non-`main`, CI continues to produce unsigned structure evidence; `main` now produces the protected signed evidence set. | [Android CI run 32783660291](https://github.com/AbdulLatef2380/AIRI-Project/actions/runs/32783660291) for `ca881a1b` succeeded end-to-end. Signed APK SHA-256 `2faf1ec9d269d58eb93c98379bf93a2fc25b4a449c6f1a6bd2c36275e32b4b98`; signed AAB `f8816b28d7751ab974fe9a0a064baf18e9558a6a94415098e784f720b40eb30a`; mapping `c988f131c9f44200a0b7be7419696d1ebadccce667ec019a7b72b8384b987b1c`; V2 certificate SHA-256 `EE:B5:1E:58:A3:71:85:F8:EC:1A:48:77:64:8F:9A:59:69:61:49:E7:0D:39:56:64:DF:F5:91:9C:82:C2:1A:F8`. | Signing is complete for this artifact; physical-device, provider, Play/legal/Data Safety, and rollout gates remain external. |
...
المرشح الموثق هو `ca881a1b` على `cp-foundation` و`main`. حافظ على إصلاحات نزاهة خطة الوكيل وصيانة WorkManager وفشل الأدوات من `ec359054`، ثم أصلح workflow اكتشاف `apksigner` من Android build-tools. نجحت [Android CI run 32783660291](https://github.com/AbdulLatef2380/AIRI-Project/actions/runs/32783660291) في كل البوابات الداخلية وفي signed APK/AAB وcertificate verification. هذه حالة **signed release candidate evidenced** فقط؛ لا تتجاوز متطلبات الجهاز والمزود والمتجر والقانون.
...
| RC-B09 | Release build/R8 | Gradle release configuration and CI | `main` run `32783660291` نجحت في release compile وR8 وsigned packaging وmapping وSHA-256 وAPI 29 instrumentation/native. | `SIGNED_RELEASE_CANDIDATE_EVIDENCED` |
| RC-B10 | Signed APK/AAB | Release owner and protected signing environment | هوية production جديدة مع recovery مشفرة خارج GitHub؛ `apksigner --verify` و`--print-certs` نجحا للحزمة الموقعة في run `32783660291`. | `SIGNED_RELEASE_CANDIDATE_EVIDENCED` / `EXTERNAL_PUBLICATION_GATES_REMAIN` |
