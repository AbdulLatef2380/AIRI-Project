...
## Description
Map modules, entry points, boundaries, and change hotspots.
...
## Inputs
repository tree and supplied source metadata

## Outputs
evidence-linked architecture map and investigation plan
...
## Limitations
Use with an exported tree or repository files; it cannot inspect unavailable files.
