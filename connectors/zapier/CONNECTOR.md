...
status: PARTIAL
author: AIRI
website: https://platform.zapier.com
---

# Zapier Connector

This document describes the AIRI connector catalog entry for **Zapier**. The entry is an AIRI adapter definition, not a claim that AIRI is the provider or owner of the external service.
