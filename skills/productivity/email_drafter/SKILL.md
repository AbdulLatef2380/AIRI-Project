---
name: email_drafter
description: Draft a professional email from intent and context Use when the user requests email drafter.
---
...
Draft a professional email from intent and context
...
Use this skill when the user's request matches `email_drafter` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to email drafter using supplied evidence.
