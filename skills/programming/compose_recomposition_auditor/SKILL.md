---
name: compose_recomposition_auditor
description: Identify avoidable recompositions and unstable UI state Use when the user requests compose recomposition auditor.
---
...
Identify avoidable recompositions and unstable UI state
...
Use this skill when the user's request matches `compose_recomposition_auditor` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to compose recomposition auditor using supplied evidence.
