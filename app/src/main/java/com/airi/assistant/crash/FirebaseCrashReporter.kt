...
object FirebaseCrashReporter {
    ...
    fun enableCollection() {
        runCatching {
            ...
            Log.i(TAG, "AIRI_PROOF CRASHLYTICS_ENABLED")
        }.onFailure { e ->
    ...
    fun disableCollection() {
        runCatching {
            ...
            Log.i(TAG, "AIRI_PROOF CRASHLYTICS_DISABLED")
        }.onFailure { e ->
    ...
    fun recordNonFatal(throwable: Throwable) {
        runCatching {
            ...
            Log.w(TAG, "AIRI_PROOF NON_FATAL_RECORDED class=${throwable::class.simpleName}")
        }.onFailure { e ->
