...
## Description
Analyze security-relevant logs for defensive signals and telemetry gaps.
...
## Inputs
redacted security logs and event context

## Outputs
defensive findings, detection ideas, containment suggestions
...
## Limitations
Use with privacy-preserving logs; never include credentials or unnecessary personal data.
