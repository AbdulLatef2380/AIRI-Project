---
name: summarizer
description: Create a faithful concise summary of text Use when the user requests summarizer.
---
...
Create a faithful concise summary of text
...
Use this skill when the user's request matches `summarizer` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to summarizer using supplied evidence.
