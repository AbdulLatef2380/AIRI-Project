...
class PromptBudgetLedger private constructor(val budget: ContextBudget) {
    ...
    fun claim(contributor: Contributor, requested: Int): Int {
        ...
        if (granted < requested) {
            Log.w(TAG,
                "AIRI BUDGET_PARTIAL contributor=${contributor.name} " +
    ...
    /**
     * Human-readable allocation report for AIRI logging.
     */
    ...
    companion object {
        ...
        fun forBudget(budget: ContextBudget): PromptBudgetLedger {
            ...
            if (thermalFactor < 1.0f) {
                ...
                Log.w(TAG,
                    "AIRI BUDGET_THERMAL_RESERVE nCtx=${budget.nCtx} " +
            ...
            Log.i(TAG,
                "AIRI BUDGET_INIT nCtx=${budget.nCtx} " +
