...
## Description
Audit data flows, minimization, retention, access, and controls.
...
## Inputs
data flow, storage, permissions, and policy evidence

## Outputs
privacy-preserving remediation and audit-ready verification
...
## Limitations
Use as an engineering audit aid, not legal advice or certification.
