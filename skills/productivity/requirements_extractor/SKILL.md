...
description: Turn prose into testable functional requirements Use when the user requests requirements extractor.
---
...
Turn prose into testable functional requirements
...
Use this skill when the user's request matches `requirements_extractor` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to requirements extractor using supplied evidence.
