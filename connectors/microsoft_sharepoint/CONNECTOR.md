...
status: COMING_SOON
author: AIRI
website: https://www.sharepoint.com
---

# SharePoint Connector

This document describes the AIRI connector catalog entry for **SharePoint**. The entry is an AIRI adapter definition, not a claim that AIRI is the provider or owner of the external service.
