...
## Description
Design safe API adapters and explicit request/response contracts.
...
## Inputs
API documentation, client requirements, and auth constraints

## Outputs
schemas, retry/error/idempotency plan, and contract tests
...
## Limitations
Use before implementing an integration. It never calls an external API or stores credentials.
