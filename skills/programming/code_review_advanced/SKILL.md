...
description: Review code for correctness, security, maintainability, and tests Use when the user requests advanced code review.
---
...
Review code for correctness, security, maintainability, and tests
...
Use this skill when the user's request matches `code_review_advanced` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to advanced code review using supplied evidence.
