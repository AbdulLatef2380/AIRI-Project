---
name: pdf_analysis
description: Official AIRI skill for pdf analysis. Use when the user requests pdf analysis.
---
...
Official AIRI skill for pdf analysis.
...
Use this skill when the user's request matches `pdf_analysis` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to pdf analysis using supplied evidence.
