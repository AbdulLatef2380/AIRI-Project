---
name: task_planner
description: Official AIRI skill for task planner. Use when the user requests task planner.
---
...
Official AIRI skill for task planner.
...
Use this skill when the user's request matches `task_planner` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to task planner using supplied evidence.
