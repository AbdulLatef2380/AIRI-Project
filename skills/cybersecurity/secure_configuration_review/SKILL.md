...
## Description
Review application and infrastructure configuration for secure defaults.
...
## Inputs
redacted configuration and deployment context

## Outputs
least-privilege remediation and non-invasive configuration tests
...
## Limitations
Use for authorized configuration review. Never connect to infrastructure or expose secrets.
