---
name: test_strategy
description: Design a layered test plan from requirements and risks Use when the user requests test strategy designer.
---
...
Design a layered test plan from requirements and risks
...
Use this skill when the user's request matches `test_strategy` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to test strategy designer using supplied evidence.
