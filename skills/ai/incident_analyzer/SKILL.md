...
description: Analyze an incident timeline and produce root-cause actions Use when the user requests incident analyzer.
---
...
Analyze an incident timeline and produce root-cause actions
...
Use this skill when the user's request matches `incident_analyzer` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to incident analyzer using supplied evidence.
