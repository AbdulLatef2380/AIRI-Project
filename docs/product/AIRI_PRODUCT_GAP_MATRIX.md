...
| T0-04 | Memory Fabric | ذاكرة قابلة للتفسير والحذف وليست مخزناً عشوائياً | `PARTIAL` | Room v8 يطبق provenance/scope/privacy/expiry وMemoryAgent لا يعلن تخزيناً كاذباً؛ RAG يمنع `PROJECT` memory غير المطابقة للمشروع قبل بناء prompt، وfixture A/B المجمعة تكتب MemoryManager في A وتثبت أن B لا يستدعيها؛ المتبقي تشغيل fixture، طبقات Working/Episodic/Semantic الكاملة والتصدير وmigration على جهاز | Core/Android/Desktop | عرض المصدر، التصحيح، الحذف، والتصدير |
