...
description: Identify bottlenecks from code, traces, or benchmark output Use when the user requests performance profiler.
---
...
Identify bottlenecks from code, traces, or benchmark output
...
Use this skill when the user's request matches `performance_profiler` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to performance profiler using supplied evidence.
