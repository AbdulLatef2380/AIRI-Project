...
check('Scheduled task evidence and execution handoff', 'jobs = jobs' in agent_tasks_screen and 'onOpenExecution = { selectedTab = 1 }' in agent_tasks_screen and 'job.lastDurableTaskId != null' in agent_tasks_screen and 'scheduled_task_view_execution' in agent_tasks_screen and 'scheduled_task_refresh' in agent_tasks_screen and 'LaunchedEffect(selectedTab)' in agent_tasks_screen, 'Scheduled UI retains completed and failed persisted jobs, supports explicit refresh without polling, and opens the durable execution surface only when a linked task exists.')
