...
## Description
Generate maintainable technical documentation from contracts and source.
...
## Inputs
source contracts, examples, and intended audience

## Outputs
structured documentation, limitations, and update triggers
...
## Limitations
Use when documentation is missing; it cannot prove behavior absent from supplied evidence.
