...
| T0-05 | Knowledge/RAG | إجابات مرتبطة بالأدلة | `PARTIAL` | RAG يحمل citation/provenance/scope/privacy للممرات؛ المتبقي Project File extraction→chunks→index، hybrid retrieval، reranking وواجهة evidence لكل claim | Core/Android/Desktop | كل claim يعرض المصدر والثقة عند توفر المعرفة |
