...
## Description
Map supplied application behavior to defensive OWASP-style risks.
...
## Inputs
application flow, code, and control evidence

## Outputs
risk mapping, controls, secure changes, and authorized test cases
...
## Limitations
Use as a review aid, not as penetration testing or certification.
