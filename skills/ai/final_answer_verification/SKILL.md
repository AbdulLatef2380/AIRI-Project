...
description: Check a draft answer against supplied evidence and execution results Use when the user requests final answer verification.
---
...
Check a draft answer against supplied evidence and execution results
...
Use this skill when the user's request matches `final_answer_verification` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to final answer verification using supplied evidence.
