---
name: reminder_planning
description: Official AIRI skill for reminder planning. Use when the user requests reminder planning.
---
...
Official AIRI skill for reminder planning.
...
Use this skill when the user's request matches `reminder_planning` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to reminder planning using supplied evidence.
