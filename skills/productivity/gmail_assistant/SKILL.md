...
description: Official AIRI skill for gmail assistant. Use when the user requests gmail assistant.
---
...
Official AIRI skill for gmail assistant.
...
Use this skill when the user's request matches `gmail_assistant` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to gmail assistant using supplied evidence.
