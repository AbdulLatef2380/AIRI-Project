---
name: api_quality_reviewer
description: Review API contracts for clarity, compatibility, and failure behavior Use when the user requests api quality reviewer.
---

# API Quality Reviewer

## Description

Review API contracts for clarity, compatibility, and failure behavior
...
Use this skill when the user's request matches `api_quality_reviewer` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to api quality reviewer using supplied evidence.
