...
check('Room schema version and export', 'version = 8' in database and 'MIGRATION_7_8' in database and 'exportSchema = true' in database and 'version = 1' in experience_store and 'exportSchema = true' in experience_store, 'The current source declares memory Room v8 with v7→v8 migration and experience Room v1 with schema export enabled.')
