---
name: research_agent
description: Official AIRI skill for research agent. Use when the user requests research agent.
---
...
Official AIRI skill for research agent.
...
Use this skill when the user's request matches `research_agent` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to research agent using supplied evidence.
