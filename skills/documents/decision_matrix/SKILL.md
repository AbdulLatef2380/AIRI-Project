...
description: Compare options against explicit criteria and trade-offs Use when the user requests decision matrix.
---
...
Compare options against explicit criteria and trade-offs
...
Use this skill when the user's request matches `decision_matrix` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to decision matrix using supplied evidence.
