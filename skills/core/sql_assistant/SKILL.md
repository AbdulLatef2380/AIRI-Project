---
name: sql_assistant
description: Write or explain SQL queries with safety checks Use when the user requests sql assistant.
---
...
Write or explain SQL queries with safety checks
...
Use this skill when the user's request matches `sql_assistant` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to sql assistant using supplied evidence.
