...
| --- | --- | --- | --- | --- | --- | --- |
| TC-01 | Kotlin 1.9.22 لا يدعم AGP 8.10.1 رسمياً في KMP. | واقع قائم | مرتفع | ترقية Kotlin/KMP إلى 2.2.21 مع إبقاء AGP ثابتاً ضمن نطاقه الرسمي. | core وAndroid وCI ينجحان بلا تحذير compatibility القديم. | مغلقة: CI نجح |
| TC-02 | KSP قد يفشل مع Kotlin الجديد أو Room compiler. | متوسط | مرتفع | أثبت Room 2.6.1 فشلاً في KSP2؛ الترقية إلى Room 2.8.4 مع KSP 2.2.21-2.0.5. | KSP debug وRoom tests/schema وCI release ينجحان. | مغلقة: CI نجح |
