---
name: file_manager
description: Official AIRI skill for file manager. Use when the user requests file manager.
---
...
Official AIRI skill for file manager.
...
Use this skill when the user's request matches `file_manager` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to file manager using supplied evidence.
