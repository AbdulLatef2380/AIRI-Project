---
name: meeting_agenda
description: Create a focused meeting agenda with outcomes and owners Use when the user requests meeting agenda.
---
...
Create a focused meeting agenda with outcomes and owners
...
Use this skill when the user's request matches `meeting_agenda` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to meeting agenda using supplied evidence.
