---
name: json_extractor
description: Extract structured fields from unstructured text Use when the user requests json extractor.
---
...
Use this skill when the user's request matches `json_extractor` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to json extractor using supplied evidence.
