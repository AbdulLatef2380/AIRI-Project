---
name: daily_task_organizer
description: Organize supplied tasks into a realistic daily plan Use when the user requests daily task organizer.
---
...
Organize supplied tasks into a realistic daily plan
...
Use this skill when the user's request matches `daily_task_organizer` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to daily task organizer using supplied evidence.
