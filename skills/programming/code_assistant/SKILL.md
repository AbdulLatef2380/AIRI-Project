---
name: code_assistant
description: Official AIRI skill for code assistant. Use when the user requests code assistant.
---
...
Official AIRI skill for code assistant.
...
Use this skill when the user's request matches `code_assistant` or its documented capability. Confirm the input scope, expected output, privacy level, and required connector or permission before execution.
...
- Ask AIRI to code assistant using supplied evidence.
