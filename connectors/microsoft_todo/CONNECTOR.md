...
status: COMING_SOON
author: AIRI
website: https://to-do.live.com
---

# Microsoft To Do Connector

This document describes the AIRI connector catalog entry for **Microsoft To Do**. The entry is an AIRI adapter definition, not a claim that AIRI is the provider or owner of the external service.
